...
def get_detail_info(work_id):
    for detail_id in work_id:
        ...
        info = soup.select('body > div.position-head > div > div.position-content-l > dd > p > span')
